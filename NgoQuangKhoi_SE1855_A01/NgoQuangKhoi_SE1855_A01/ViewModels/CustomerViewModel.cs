...
using Repositories; // For MessageBox
...
namespace NgoQuangKhoiWPF.ViewModels
{
    public class CustomerViewModel : ViewModelBase
    {
        ...
        {
            // Create a repository instance first
            ICustomerRepository customerRepository = new Repositories.CustomerRepository();

            // Pass the repository to the CustomerService constructor
